    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10 m-auto mb-5">
          ...
          <p class=""><strong>{{ pageData.description }} </strong></p>
          ...
          <p>
            ...
            to improve and analyze Our Service. The technologies We use may include Cookies or Browser Cookies. A cookie
            is a small file placed on Your Device. You can instruct Your browser to refuse all Cookies or to indicate
            when a Cookie is being sent. However, if You do not accept Cookies, You may not be able to use some parts of
            our Service. Unless you have adjusted Your browser setting so that it will refuse Cookies, our Service may
            use Cookies
          </p>
          ...
          <h5>Contact Me</h5>
          <p>If you have any questions about this Privacy Policy, You can contact me here: <a
              href="https://turnerkendall.com/contact">https://turnerkendall.com/contact</a> </p>
        </div>
      </div>
    </div>
  </section>
...
const pageData = ref(
  {
    title: 'Privay Policy',
    subtitle: 'The VueDash Privacy Policy',
